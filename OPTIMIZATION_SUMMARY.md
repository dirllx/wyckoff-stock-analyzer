...
| 版本 | 日期 | 说明 |
|------|------|------|
| v2026-04-10-v1 | 2026-04-10 | 极简模式实现 + 前端测试诊断 |
...
### 极简模式实现
- **minimal.css** (1205行) - 完整的极简模式样式系统
- **MinimalMode切换功能** - 支持localStorage持久化
- **UI简化** - 移除健康状态栏、快捷操作栏等冗余元素
- **设计理念** - 基于乔布斯"Less is More"原则

### 前端测试诊断
- **165个测试通过** (80%+覆盖率)
- 通过的模块：formatting、watchlistManager、helpers、errorHandler、toast、wyckoff
- 12个测试文件因vitest解析问题待修复（不影响应用功能）
